...
SpaceONE은 Zabbix와 연동하기 위해 Zabbix Webhook을 제공하고 있습니다.  
본 가이드는 Zabbix에서 보내는 Alert을 SpaceONE으로 수신하기 위한 설정 방법을 안내 합니다.  
설정 방법은 아래와 같은 순서로 수행합니다.

[1. Zabbix Webhook 설정(SpaceONE)](./GUIDE.md/#1-zabbix-webhook-설정)  
...
이 Media에 SpaceONE의 Webhook URL을 명세하여 Zabbix에서 발생하는 Alert을 SpaceONE으로 전송이 가능합니다.
...
SpaceONE에서 Zabbix Webhook을 생성하면 Webhook URL을 획득할 수 있습니다.  
다음 단계를 통해 알아보도록 하겠습니다.

(1) SpaceONE의 얼럿 매니저에서 [서비스]을 클릭 합니다.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[웹훅] 버튼을 클릭하면 현재 생성된 웹훅 목록을 볼 수 있습니다.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[+ 생성] 버튼을 클릭하여 새로운 Zabbix Webhook을 생성합니다.

<img src="GUIDE-img/zabbix-webhook-setting(h2)-1.png" width="80%" height="80%">

(2) 페이지가 이동되면 [Zabbix Webhook]을 선택 후 [계속하기] 버튼을 클릭 합니다.

<img src="GUIDE-img/zabbix-webhook-setting(h2)-2.png" width="80%" height="80%">

(3) 페이지가 이동되면 [이름]을 입력한 후 [생성] 버튼을 클릭 합니다.

<img src="GUIDE-img/zabbix-webhook-setting(h2)-3.png" width="80%" height="80%">

(4) 생성된 Zabbix Webhook을 확인할 수 있습니다.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`webhook URL`은 Zabbix와 연동을 위해 사용됩니다.

<img src="GUIDE-img/zabbix-webhook-setting(h2)-4.png" width="80%" height="80%">
...
Zabbix의 Media를 설정 하겠습니다. 여기서는 SpaceONE에서 생성한 Webhook URL이 사용될 예정입니다.

(1) Zabbix 콘솔 로그인 > [Alerts] > [Media types] > [Create media type] 버튼을 클릭 합니다.

<img src="GUIDE-img/zabbix-media-setting(h2)-1.png" width="80%" height="80%">

(2) Media type에 대한 세부 설정을 진행 합니다.

<img src="GUIDE-img/zabbix-media-setting(h2)-2.png" width="80%" height="80%">

(2-1) 다음으로 Zabbix에서 SpaceONE로 보낼 데이터의 Parameter를 명세 합니다. 아래 그림과 같이 설정 합니다.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Parameter의 [Name]이 `webhookURL`인 것의 [Value]는 [1. Zabbix Webhook 설정(SpaceONE)](./GUIDE.md/#1-zabbix-webhook-설정)에서 획득한 `Webhook URL`을 사용 합니다.

<img src="GUIDE-img/zabbix-media-setting(h2)-3.png" width="80%" height="80%">

(2-2) [Script]에 아래 코드를 기입 합니다.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SpaceONE는 Zabbix의 기존 Media 유형 중 만족하는 것이 없기 때문에 이를 처리할 스크립트를 만들어야 합니다.
...
<img src="GUIDE-img/zabbix-media-setting(h2)-7.png" width="80%" height="80%">
...
(3) [Type]은 [1. Zabbix Webhook 설정(SpaceONE)](./GUIDE.md/#1-zabbix-webhook-설정)에서 생성한 `CloudForet Webhook`을 선택 합니다.  
...
<img src="GUIDE-img/users-media-setting(h2)-7.png" width="80%" height="80%">

<img src="GUIDE-img/users-media-setting(h2)-8.png" width="80%" height="80%">
...
(3)[Operations] > [Add] 버튼과 [Update] 버튼을 클릭 합니다.  
...
<img src="GUIDE-img/trigger-actions-setting(h2)-6.png" width="80%" height="80%">

(4) 모든 설정이 완료 되었다면 [Add] 버튼을 클릭 합니다.

<img src="GUIDE-img/trigger-actions-setting(h2)-7.png" width="80%" height="80%">

가이드의 설정이 모두 끝났다면 SpaceONE에서 Zabbix의 Alert을 수신 할 수 있습니다.
